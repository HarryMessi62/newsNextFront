      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">CryptoNews</h2>
                <p className="text-sm text-gray-400">UK</p>
              </div>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Your premier source for cryptocurrency news, analysis, and market insights in the United Kingdom. 
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@cryptonews.uk</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-gray-400" />
                <span className="text-gray-400">+44 (0) 20 7946 0958</span>
              </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 CryptoNews UK. All rights reserved. | 
